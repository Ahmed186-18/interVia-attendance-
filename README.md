...
| `SEED_ADMIN_NAME` | اختياري | اسم المدير الأول، والافتراضي `System Admin` |
...
بعد نجاح أول نشر وتسجيل الدخول، غيّر كلمة مرور المدير من داخل النظام ثم احذف `SEED_ADMIN_PASSWORD` من Vercel. احتفظ بـ `SEED_ADMIN_EMAIL` حتى تتعرف عمليات النشر اللاحقة على المدير الموجود دون محاولة إنشائه من جديد.
